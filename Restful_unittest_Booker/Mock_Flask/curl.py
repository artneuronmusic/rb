...
# error: non-existing id get id 6 and 
curl -i http://127.0.0.1:5000/booking/6
...
curl -i -H "Content-Type: application/json" -X POST -d '{"firstname": "Randal", "lastname": "Schmidt", "totalprice": 230, "depositpaid": false,"bookingdates": {"checkin": "2018-01-05", "checkout": "2018-01-07"}, "additionalneeds": "extra water bottles"}' http://127.0.0.1:5000/booking
      
#create the same booking content
curl -i -H "Content-Type: application/json" -X POST -d '{"firstname": "Chole", "lastname": "Bryson", "totalprice": 230, "depositpaid": false, "bookingdates": {"checkin": "2018-01-05","checkout": "2018-01-07"}, "additionalneeds": "extra water bottles"}' http://127.0.0.1:5000/booking


#err: create new booking with missing value
curl -i -H "Content-Type: application/json" -X POST -d '{"firstname": "", "lastname": "Bryson", "totalprice": 230, "depositpaid": false, "bookingdates": { "checkin": "","checkout": ""}, "additionalneeds": "extra water bottles"}}' http://127.0.0.1:5000/booking
            
#err: create new booking with missing value
curl -i -H "Content-Type: application/json" -X POST -d '{"": "Lion", "lastname": "Bryson", "totalprice": 230, "depositpaid": false, "bookingdates": { "checkin": "","checkout": ""}, "additionalneeds": "extra water bottles"}}' http://127.0.0.1:5000/booking

# update with valid id and valid info
curl -i -H "Content-Type: application/json" -X PUT -d '{"firstname": "Jason", "lastname": "Duches", "totalprice": 500, "depositpaid": false, "bookingdates": {"checkin": "2019-01-01", "checkout": "2019-01-05"}, "additionalneeds": "Room services: water bottles and some snacks", "booking id": 1}' http://127.0.0.1:5000/booking/1


#delete existing id
curl -i -H "Content-Type: application/json" -X DELETE http://127.0.0.1:5000/booking/3
